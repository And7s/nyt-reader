# Project 2 - New York Times Reader

NYT Reader is an android app that allows a user to search for articles on web using simple filters. The app utilizes [New York Times Search API](http://developer.nytimes.com/docs/read/article_search_api_v2).
...
Busy with other tasks. So unfortunately I didnt find too much time for this assignment.
...
## License
    ...
    Copyright [2017] [Andreas Schmelz]
